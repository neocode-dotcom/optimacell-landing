      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">Optimacell</h3>
            <p className="text-gray-400 max-w-md">
              Tu blindaje celular completo con tecnología metilada de alta biodisponibilidad. 
              Diseñado para cuerpos que exigen rendimiento real.
            </p>
            ...
            <div className="mt-6 space-y-2 text-sm">
              ...
              <p className="flex items-center gap-2 text-green-400">
                ...
                Recogida disponible - Listo en 1 hora
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#como-tomar" className="hover:text-green-400 transition-colors">Cómo tomarlo</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-green-400 transition-colors">Recogida en tienda</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm">
            © 2026 Optimacell by A Lo Natural. Todos los derechos reservados.
          </p>
